      ...
      <div className="max-w-4xl w-full bg-white rounded-[2rem] overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-orange-100 to-amber-200 p-12 text-teal-900 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-12">
              ...
              <div className="flex flex-col justify-center">
                <span className="text-5xl font-bold tracking-[0.10em] leading-none mb-1 text-teal-900">TOMOSA</span>
                <span className="text-[11px] tracking-[0.35em] text-teal-700 font-semibold uppercase pl-1">Acquire to Aspire</span>
              </div>
            </div>
            ...
            <p className="text-teal-800 max-w-xs mb-8 font-medium">
                Welcome to TOMOSA login page. Please enter your details to access your account and continue your journey with us.
            </p>
          ...
          <div className="relative z-10 mt-12">
            <p className="text-teal-800 font-medium">Don't have an account?</p>
            <a href="/register" className="text-teal-900 font-bold hover:underline">Register now</a>
          </div>
        </div>
        ...
        <div className="md:w-1/2 p-12 bg-white flex flex-col justify-center">
          <div className="mb-10">
            ...
            <h3 className="text-2xl font-bold text-teal-900 mb-2">Log In to your account</h3>
            <p className="text-gray-500">to continue</p>
          </div>

          <div className="flex p-1.5 bg-gray-50 border border-gray-200 rounded-xl mb-8">
            <button
              type="button"
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-teal-600 hover:underline font-medium">forgot password?</a>
            </div>

            <button 
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-orange-300 to-amber-400 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all"
            >
              LOG IN
            </button>
